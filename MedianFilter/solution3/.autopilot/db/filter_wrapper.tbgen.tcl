set C_TypeInfoList {{ 
"filter_wrapper" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"in_array": [[], {"array": ["0", [360000]]}] }, {"out_array": [[], {"array": ["1", [357604]]}] }],[],""], 
"0": [ "Input_Type", {"typedef": [[[], {"scalar": "int"}],""]}], 
"1": [ "Output_Type", {"typedef": [[[], {"scalar": "int"}],""]}]
}}
...
set C_modelName {filter_wrapper}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 2}  }
	{ in_array int 32 regular {axi_slave 0}  }
	{ out_array int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "in_array","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "in_array","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 359999,"step" : 1}]},{"cName": "out_array","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "out_array","bundle": "AXILiteS"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 357603,"step" : 1}]}]}]} , 
 	{ "Name" : "in_array", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "out_array", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":31}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"filter_wrapper","role":"start","value":"0","valid_bit":"0"},{"name":"filter_wrapper","role":"continue","value":"0","valid_bit":"4"},{"name":"filter_wrapper","role":"auto_start","value":"0","valid_bit":"7"},{"name":"in_array","role":"data","value":"16"},{"name":"out_array","role":"data","value":"24"}] },
	...
	{ "name": "s_axi_AXILiteS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "ARADDR" },"address":[{"name":"filter_wrapper","role":"start","value":"0","valid_bit":"0"},{"name":"filter_wrapper","role":"done","value":"0","valid_bit":"1"},{"name":"filter_wrapper","role":"idle","value":"0","valid_bit":"2"},{"name":"filter_wrapper","role":"ready","value":"0","valid_bit":"3"},{"name":"filter_wrapper","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "8", "9", "10", "11", "12"],
		...
		"VariableLatency" : "1",
		"InputProcess" : [
			{"ID" : "3", "Name" : "write_pixels_to_stre_U0"}],
		"OutputProcess" : [
			{"ID" : "8", "Name" : "read_pixels_from_str_U0"}],
		"Port" : [
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "write_pixels_to_stre_U0", "Port" : "in_array"},
					{"ID" : "8", "SubInstance" : "read_pixels_from_str_U0", "Port" : "out_array"}]},
			{"Name" : "in_array", "Type" : "None", "Direction" : "I"},
			{"Name" : "out_array", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.filter_wrapper_AXILiteS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.filter_wrapper_gmem_m_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.write_pixels_to_stre_U0", "Parent" : "0",
		...
		"VariableLatency" : "1",
		"Port" : [
			{"Name" : "in_stream_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "4", "DependentChan" : "9",
				"BlockSignal" : [
			...
			{"Name" : "out_array", "Type" : "None", "Direction" : "I"},
			{"Name" : "out_array_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "8", "DependentChan" : "10",
				"BlockSignal" : [
					{"Name" : "out_array_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.filter_U0", "Parent" : "0", "Child" : ["5", "6", "7"],
		"CDFG" : "filter",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"FunctionPipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
		...
		"Port" : [
			{"Name" : "in_stream_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "3", "DependentChan" : "9",
				"BlockSignal" : [
					{"Name" : "in_stream_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "out_stream_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "8", "DependentChan" : "11",
				"BlockSignal" : [
					{"Name" : "out_stream_V_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.filter_U0.temp_array_0_U", "Parent" : "4"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.filter_U0.temp_array_1_U", "Parent" : "4"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.filter_U0.grp_bubble_sort_fu_196", "Parent" : "4",
		"CDFG" : "bubble_sort",
	...
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.read_pixels_from_str_U0", "Parent" : "0",
		...
		"VariableLatency" : "1",
		"Port" : [
			{"Name" : "out_stream_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "4", "DependentChan" : "11",
				"BlockSignal" : [
					{"Name" : "out_stream_V_blk_n", "Type" : "RtlSignal"}]},
			...
			{"Name" : "out_array_offset", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "3", "DependentChan" : "10",
				"BlockSignal" : [
					{"Name" : "out_array_offset_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.in_stream_V_U", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.out_array_c_U", "Parent" : "0"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.out_stream_V_U", "Parent" : "0"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_filter_U0_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	filter_wrapper {
		gmem {Type IO LastRead 8 FirstWrite -1}
		in_array {Type I LastRead 0 FirstWrite -1}
		out_array {Type I LastRead 0 FirstWrite -1}}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "360028", "Max" : "360028"}
	, {"Name" : "Interval", "Min" : "360015", "Max" : "360015"}
]}
...
set busDeadlockParameterList { 
	{ gmem { NUM_READ_OUTSTANDING 2 NUM_WRITE_OUTSTANDING 2 MAX_READ_BURST_LENGTH 256 MAX_WRITE_BURST_LENGTH 256 } } \
}
