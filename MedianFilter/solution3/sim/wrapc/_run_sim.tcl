...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "filter_wrapper.autotvin.dat"
	set constFileTvOut       "filter_wrapper.autotvout.dat"
	set constFileHdlTvIn     "filter_wrapper.autohdltvin.dat"
	set constFileHdlTvOut    "filter_wrapper.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
