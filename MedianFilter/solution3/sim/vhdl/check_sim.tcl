...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.filter_wrapper.autotvin_gmem.dat"
         "c.filter_wrapper.autotvin_in_array.dat"
         "c.filter_wrapper.autotvin_out_array.dat"
         "c.filter_wrapper.autotvout_gmem.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.filter_wrapper.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
